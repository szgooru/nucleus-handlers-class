...
class RemoveInviteHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    try {
      AJClassMember.delete(AJClassMember.DELETE_INVITE_QUERY_FILTER, context.classId(), context.studentEmail());
      return new ExecutionResult<>(
          MessageResponseFactory.createNoContentResponse(RESOURCE_BUNDLE.getString("invite.removed"),
