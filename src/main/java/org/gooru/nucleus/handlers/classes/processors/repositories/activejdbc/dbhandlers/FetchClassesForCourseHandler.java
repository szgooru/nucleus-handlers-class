...
class FetchClassesForCourseHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        if (context.courseId() == null || context.courseId().isEmpty()) {
            ...
            return new ExecutionResult<>(
                MessageResponseFactory.createInvalidRequestResponse(RESOURCE_BUNDLE.getString("missing.course")),
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        try {
            ...
            return new ExecutionResult<>(
                MessageResponseFactory.createOkayResponse(new JsonObject().put(RESPONSE_BUCKET_CLASSES, classesList)),
